...
$$\begin{align*}p^g_{3,0}(x) &=g(0)+\frac{g'(0)}{1!}x+\frac{g''(0)}{2!}x^2+\frac{g'''(0)}{3!}x^3\\[2ex]&=1+\frac{-2}{1!}x+\frac{4}{2!}x^2+\frac{-8}{3!}x^3\end{align*}$$ 


<!--stackedit_data:
eyJoaXN0b3J5IjpbLTY3NzUxMTYwMiw4Njc5MjcwNjgsLTUwOD
