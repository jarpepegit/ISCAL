...
> $\log L = \displaystyle\lim_{x\to+\infty}\frac{1}{\log(x+1)}\log(x)=\lim_{x\to+\infty}\frac{\frac{1}{x}}{\frac{1}{x+1}}=\lim_{x\to+\infty}\frac{x+1}{x}=1$
> $\log L=1\implies L=e$


> Written with [StackEdit](https://stackedit.io/).
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE1MzM1MzE3MDksLTIwMTQwNDU3NjEsNz
